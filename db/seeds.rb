...
three_d_printed_snorkel_comment_1 = Comment.create!(user_id: alec.id, project_id: three_d_printed_snorkel.id, body: "How fun! I love what can be made with 3D printers. ", username: alec.username)
three_d_printed_snorkel_comment_2 = Comment.create!(user_id: larry.id, project_id: three_d_printed_snorkel.id, body: "Apart from a fun looking build, testing must have been a blast!", username: larry.username)
three_d_printed_snorkel_comment_3 = Comment.create!(user_id: jane.id, project_id: three_d_printed_snorkel.id, body: "Very cool! One more reason to add to my 'Why I need a 3d printer' list :)", username: jane.username)

chess_table_comment_1 = Comment.create!(user_id: joe.id , project_id: chess_table.id, body: "You can never go wrong with a chess table!", username: joe.username)
chess_table_comment_2 = Comment.create!(user_id: scott.id, project_id: chess_table.id, body: "This is a great way to take the game outside and not worry about the board!", username: scott.username)
chess_table_comment_3 = Comment.create!(user_id: jane.id, project_id: chess_table.id, body: "Great idea to use all weather paint!", username: jane.username)

gopro_nosecone_comment_1 = Comment.create!(user_id: beno.id, project_id: gopro_nosecone.id, body: "What a fun concept, I bet the videos are fun. Did you get dizzy watching them?", username: beno.id)
gopro_nosecone_comment_2 = Comment.create!(user_id: nemo.id, project_id: gopro_nosecone.id, body: "LOL, the videos are fun and although I did not get dissy watching them my dad did... said it was almost too much.", username: nemo.id)
gopro_nosecone_comment_3 = Comment.create!(user_id: ryan.id, project_id: gopro_nosecone.id, body: "This is really neat!", username: ryan.id)

halfpipe_comment_1 = Comment.create!(user_id: christopher.id, project_id: halfpipe.id, body: "Very cool, always wanted my own halfpipe. Now I can build it myself.", username: christopher.username)
halfpipe_comment_2 = Comment.create!(user_id: mary.id, project_id: halfpipe.id, body: "This is an impressive undertaking", username: mary.username)
halfpipe_comment_3 = Comment.create!(user_id: spencer.id, project_id: halfpipe.id, body: "I like how you set the rail in the top edges.", username: spencer.username)

pergola_comment_1 = Comment.create!(user_id: alice.id, project_id: pergola.id, body: "Very nice. Very professional!", username: alice.username)
pergola_comment_2 = Comment.create!(user_id: nemo.id, project_id: pergola.id, body: "This looks fantastic, I think we could modify the project parameters to build one on our small patio.", username: nemo.username)
pergola_comment_3 = Comment.create!(user_id: alec.id, project_id: pergola.id, body: "This is a great way to make the yard more inviting. I'll have to share it with my folks.", username: alec.username)

spool_comment_1 = Comment.create!(user_id: lizzy.id, project_id: spool.id, body: "This is way more effective than a screwdriver and spool held between my knees, pole trapped in the back of a chair and free hand turing the reel. Thanks for sharing!", username: lizzy.username)
spool_comment_2 = Comment.create!(user_id: joe.id, project_id: spool.id, body: "Taking my niece and nephew fishing this weekend. Perhaps we'll have a spooling party when they arrive.", username: joe.username)
spool_comment_3 = Comment.create!(user_id: scott.id, project_id: spool.id, body: "Great tutorial! Thanks.", username: scott.username)

solar_balloon_comment_1 = Comment.create!(user_id: larry.id, project_id: solar_balloon.id, body: "How fun, I think I'll share this with my class next month for one of our weekly science experiements.", username: larry.username)
solar_balloon_comment_2 = Comment.create!(user_id: jane.id, project_id: solar_balloon.id, body: "Agreed, I think I'll add this to our afterschool program. We're always looking for fun projects for our kids.", username: jane.username)
solar_balloon_comment_3 = Comment.create!(user_id: beno.id, project_id: solar_balloon.id, body: "Yeah science!!!", username: beno.username)

wood_trivits_comment_1 = Comment.create!(user_id: hayden.id, project_id: wood_trivits.id, body: "My partner followed your tutorial and made us some great trivits. We use them all the time!", username: hayden.username)
wood_trivits_comment_2 = Comment.create!(user_id: ryan.id, project_id: wood_trivits.id, body: "I love all the different patterns.", username: ryan.username)
wood_trivits_comment_3 = Comment.create!(user_id: christopher.id, project_id: wood_trivits.id, body: "Thanks for sharing! This looks like a fun project.", username: christopher.username)

arduino_grow_box_comment_1 = Comment.create!(user_id: mary.id, project_id: arduino_grow_box.id, body: "This is great!, I have no garden space and this will change everything.", username: mary.username)
arduino_grow_box_comment_2 = Comment.create!(user_id: spencer.id, project_id: arduino_grow_box.id, body: "Very, very cool!", username: spencer.username)
arduino_grow_box_comment_3 = Comment.create!(user_id: alice.id, project_id: arduino_grow_box.id, body: "Yeah, indoor herb garden!", username: alice.username)

led_shpere_comment_1 = Comment.create!(user_id: nemo.id, project_id: led_shpere.id, body: "This looks fun, I'll have to work on my soldering skills before attempting this one.", username: nemo.username)
led_shpere_comment_2 = Comment.create!(user_id: lizzy.id, project_id: led_shpere.id, body: "Have you thought about selling a kit?", username: lizzy.username)
led_shpere_comment_3 = Comment.create!(user_id: alec.id, project_id: led_shpere.id, body: "Just beautiful!!", username: alec.username)

nixie_clock_comment_1 = Comment.create!(user_id: larry.id, project_id: nixie_clock.id, body: "I love these clocks!", username: larry.username)
nixie_clock_comment_2 = Comment.create!(user_id: joe.id, project_id: nixie_clock.id, body: "Yeah they're great! Really fun. An entertaining way to watch time pass...", username: joe.username)
nixie_clock_comment_3 = Comment.create!(user_id: scott.id, project_id: nixie_clock.id, body: "Adding this to my summer build list!", username: scott.username)

friendship_bracelet_comment_1 = Comment.create!(user_id: jane.id, project_id: friendship_bracelet.id, body: "Can't go wrong with a good friendship bracelet; going to share this with my kids.", username: jane.username)
friendship_bracelet_comment_2 = Comment.create!(user_id: beno.id, project_id: friendship_bracelet.id, body: "I shared this with my neighbors kids a couple weeks ago and they have had a great time with it.", username: beno.username)
friendship_bracelet_comment_3 = Comment.create!(user_id: hayden.id, project_id: friendship_bracelet.id, body: "Great tutorial, thanks for sharing.", username: hayden.username)

analog_synth_comment_1 = Comment.create!(user_id: christopher.id, project_id: analog_synth.id, body: "Way cool!", username: christopher.username)
analog_synth_comment_2 = Comment.create!(user_id: mary.id, project_id: analog_synth.id, body: "I've only made digital ones with coded loops. Gonna have to give this a try.", username: mary.username)
analog_synth_comment_3 = Comment.create!(user_id: spencer.id, project_id: analog_synth.id, body: "This is great!", username: spencer.username)

bike_chain_comment_1 = Comment.create!(user_id: ryan.id, project_id: bike_chain.id, body: "Every summer I take my bike to the shop downtown for a tune up and it's pretty much just chain maintenance. This year I'll be doing it myself! Thanks =)", username: ryan.username)
bike_chain_comment_2 = Comment.create!(user_id: alice.id, project_id: bike_chain.id, body: "We've been planning to teach the kids in the neighborhood some basic care instructions for their bikes and scooters. We'll definitely be sharing some of your pointers.", username: alice.username)
bike_chain_comment_3 = Comment.create!(user_id: nemo.id, project_id: bike_chain.id, body: "Great instructions, thanks for shaing.", username: nemo.username)

tie_knots_comment_1 = Comment.create!(user_id: lizzy.id, project_id: tie_knots.id, body: "My son picked up a book last week about knots, we may build this for one of his class 'how-to' projects.", username: lizzy.username)
tie_knots_comment_2 = Comment.create!(user_id: alec.id, project_id: tie_knots.id, body: "This remindes me of learning to tie knots with my grandfatehr when I was little. Thanks for sharing and thanks for the memories =)", username: alec.username)
tie_knots_comment_3 = Comment.create!(user_id: larry.id, project_id: tie_knots.id, body: "This is great! I've pretty muched handled everything with a bowline and a trucker's hitch. I'll definitely be adding some knots to my repertoire this summer!!", username: larry.username)

visualizer_comment_1 = Comment.create!(user_id: joe.id, project_id: visualizer.id, body: "This is so much fun. My uncle had a similar visualizer he made way back. He always had it hooked up to the stereo in his garage and I was always memsmorized by it. I'll be looking into making my own now. Thanks!", username: joe.username)
visualizer_comment_2 = Comment.create!(user_id: scott.id, project_id: visualizer.id, body: "This is really really cool. I'll have to start looking for an old tv to fiddle with...", username: scott.username)
visualizer_comment_3 = Comment.create!(user_id: jane.id, project_id: visualizer.id, body: "My kid has been looking for a fun project for this year's science fair. I'll have to share this with her.", username: jane.username)

extinguisher_comment_1 = Comment.create!(user_id: beno.id, project_id: extinguisher.id, body: "How fun, a great place to keep a special bottle", username: beno.username)
extinguisher_comment_2 = Comment.create!(user_id: hayden.id, project_id: extinguisher.id, body: "This is a fun concept, it'd be fun to try with different sized extinguishers for different sized bottles.", username: hayden.username)
extinguisher_comment_3 = Comment.create!(user_id: ryan.id, project_id: extinguisher.id, body: "Nice! That's fun.", username: ryan.username)

gas_turbine_comment_1 = Comment.create!(user_id: christopher.id, project_id: gas_turbine.id, body: "Just WOW!", username: christopher.username)
gas_turbine_comment_2 = Comment.create!(user_id: mary.id, project_id: gas_turbine.id, body: "Yeah, I have to agree with @topher on this one, WOW!", username: mary.username)
gas_turbine_comment_3 = Comment.create!(user_id: spencer.id, project_id: gas_turbine.id, body: "Agreed... WOW!", username: spencer.username)

tesla_coil_comment_1 = Comment.create!(user_id: alice.id, project_id: tesla_coil.id, body: "Yeah for Tesla Coils. I have been fascinated with them for years. Always looking for a reason to build another. I'll have to give your build a shot.", username: alice.username)
tesla_coil_comment_2 = Comment.create!(user_id: nemo.id, project_id: tesla_coil.id, body: "I've been thinking about picking up a kit but with your great instructions now I don't have to! Thanks for sharing.", username: nemo.username)
tesla_coil_comment_3 = Comment.create!(user_id: alec.id, project_id: tesla_coil.id, body: "Loved this build, my roommate and I had a great time making it!", username: alec.username)

stirling_engine_comment_1 = Comment.create!(user_id: lizzy.id, project_id: stirling_engine.id, body: "These engines are too cool!", username: lizzy.username)
stirling_engine_comment_2 = Comment.create!(user_id: larry.id, project_id: stirling_engine.id, body: "What fun!", username: larry.username)
stirling_engine_comment_3 = Comment.create!(user_id: joe.id, project_id: stirling_engine.id, body: "I made one of these years ago and forgot all about it. I'll have to see if I can find it and get it working again.", username: joe.username)

theremin_organ_synth_comment_1 = Comment.create!(user_id: scott.id, project_id: theremin_organ_synth.id, body: "That's really fun, thanks for sharing. I made a couple with my daughter and she had a blast. It was also a great way to introduce her to small electronics.", username: scott.username)
theremin_organ_synth_comment_2 = Comment.create!(user_id: jane.id, project_id: theremin_organ_synth.id, body: "Love this project! I've made a few in the past. Have you tried combining this with an arduino module?", username: jane.username)
theremin_organ_synth_comment_3 = Comment.create!(user_id: beno.id, project_id: theremin_organ_synth.id, body: "Very cool!", username: beno.username)
